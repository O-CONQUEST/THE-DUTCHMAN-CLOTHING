  ...
  return (
    <nav className="flex items-center justify-between px-6 py-4 border-b border-neutral-100 sticky top-0 bg-white z-[100]">
      <div className="flex-1">
        <Link
          href="/collection"
          className="text-[10px] font-bold uppercase tracking-[0.2em] hover:opacity-60 transition"
        >
          Collection
        </Link>
      </div>
            ...
            {menuOpen && (
              <div className="absolute right-0 mt-3 w-40 bg-white border border-neutral-100 shadow-lg py-2 z-[110]">
                <button
                  ...
                  className="w-full text-left px-4 py-2 text-[9px] font-bold uppercase tracking-widest hover:bg-neutral-50 transition"
                >
                  Sign Out
                </button>
              </div>
