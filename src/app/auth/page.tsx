...
export default function AuthPage() {
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    // Find out where the user should go after login
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-white p-6 font-sans text-black">
      <div className="w-full max-w-sm space-y-10">
        ...
        <form onSubmit={handleAuth} className="space-y-6">
          <input 
            ...
            placeholder="EMAIL" 
            required
            className="w-full border-b border-black py-3 text-[10px] tracking-widest focus:outline-none uppercase font-bold bg-transparent"
